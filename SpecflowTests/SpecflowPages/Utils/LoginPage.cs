  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("/html/body/div[2]/div/div/div[1]/div/div[1]/input")).SendKeys("divyarao.devaraneni@gmail.com");
           ...
           // IWebElement hidivya = Driver.driver.FindElement(By.XPath("//span[contains(.,'Divya')]"));
           // Thread.Sleep(10000);
